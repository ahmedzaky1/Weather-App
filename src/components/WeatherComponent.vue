<template>
  <div class="container p-0">
    <div class="d-flex">
      <div
        class="card main-div w-100"
        style="
          background-image: url(https://images.pexels.com/photos/3540375/pexels-photo-3540375.jpeg?auto=compress&cs=tinysrgb&w=600);
          border-radius: 20px;
          color: #fff;
      ...
      <div
        class="card card-2 w-100"
        style="background-color: #212730; border-radius: 20px"
      >
        <table class="m-4">
          <tbody>
            <tr>
...
export default (await import("vue")).defineComponent({
  ...
  async created() {
    const response = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${this.city}&units=metric&appid=48c63522a57ecd2af48aa88228fbc80c`
    );
